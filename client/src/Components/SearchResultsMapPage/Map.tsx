...
export default function Map(props: SearchProps) {
  ...
  useEffect(() => {
    getLatLongFromString(city as string);
  }, []);
      ...
      <div className="map">
        ...
        >
                ...
                return (
                  <>
                    <Marker
                      key={index}
                      position={{
                        lat: Number(spot.addresses[0].latitude),
                        lng: Number(spot.addresses[0].longitude),
                      }}
                      onClick={() => {
                        fetchDirections(
                          {
          ...
          {selectedMarker && (
            ...
            >
              <Link to={`/event/${selectedMarker.spotData.id}`} target="_blank">
